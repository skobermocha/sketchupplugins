...
# and exports to CBECC Res .ribd* file.
...
#module SkoberCoders
	#module ExportCBECC
		...
		unless file_loaded?(__FILE__)
		  	dtToolsMenu = UI.menu("PlugIns").add_submenu("DT Tools")

		  	if (dtToolsMenu)
				#Add Menu Items list string, Method to call
				dtToolsMenu.add_item("Export to CBECC") {getMaterialData(Sketchup.active_model) }
			else
				UI.messagebox "Failure creating DT Tools Menu."
			end
